...
public class CoverColorDataGetter extends DataGetterBase implements DataGetter{
	private final static Log log = LogFactory.getLog(CoverColorDataGetter.class);
     ...
     * Note: This is a class setup for the workshop and mostly copies SparqlQueryDataGetter except
     * the query has hard-coded in this case. 
     */
    public CoverColorDataGetter(VitroRequest vreq, Model displayModel, String dataGetterURI){
